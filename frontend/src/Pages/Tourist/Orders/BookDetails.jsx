...
const breadcrumbItems = [
  ...
  { label: "Order Details", link: "/BookDetails" },
];
...
const activityStartDate = new Date(state?.ActivityId?.start_date);
...
>
  ...
  >
    <div className="order-d-top-l">
      ...
      >
        Total : {currencyFormat(state.TotalPrice)}
      </p>
    </div>
              ...
              {!done && <OrderDetailStatusWrapper className="order-d-status" style={{marginBottom:"10px"}}>
                <div className="order-status bg-silver">
                  ...
                  <div className={`order-status-dot status${timeDifference <= 48?"-current":"-done"} bg-silver`} style={{marginTop:"-12px",marginBottom:"10px"}}>
                    <span className="order-status-text font-semibold text-center no-wrap text-silver">
                      Can't cancel beore 48 hours of theactivity
                    </span>
                  </div>
...
\
              ...
              
                {
                  ...
                  >
                    ...
                    >
                      <img
                        src={folderPics+""+book.ActivityId}
                        alt={state?.name}
                        style={{
                          width: "100%",
                          height: "100%",
                    ...
                    >
                      ...
                      >
                        <span style={{ fontWeight: "600" }}>Price:</span> {state.ActivityId.price.min || "N/A"}
                      </p>
                      <p
                        style={{
                          fontSize: "14px",
